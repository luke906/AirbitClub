...
def transfer_reward_commission_money(index, str_destination_id, str_login_id, str_login_password,
    ...
    if _rewards > 0:
        ...
        # 토큰을 요청하고 메일에서 토큰을 받아온다.
        mail_scheduler = Schedule_Manager()
        mail_scheduler.start_scheduler_interval(get_airbit_token_value, "token_job_rewards", 10,
                                                str_credential_filename)
